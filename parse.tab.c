...
{
  "$end", "error", "$undefined", "T_NUMBER", "T_INTEGER", "T_FLOAT",
  "T_VARIABLE", "T_EQUAL", "T_ADD", "T_SUBTRACT", "T_MULTIPLY", "T_DIVIDE",
  "T_EOL", "$accept", "calculation", "expression", "factor", "term", YY_NULLPTR
};
#endif
